# -*- coding: utf-8 -*-
"""
Created on Sat Sep  7 11:32:07 2019
...
#log Me
def logme(orignalfile_string, dt_string_string, username_string, noOfPrint_string, outputFileName_string):    
    # field names 
    fields = ['File Name With Path', 'Date and Time', "User Naem", "No of Print", "Output File Name"]         
    # name of csv file 
    filename = "log_me.csv"
    
    rows = [orignalfile_string, dt_string_string, username_string, noOfPrint_string, outputFileName_string]
...
def final_balance(entries):
   ...
   #print(entries['INPUT PATH'].get())
    ...
    orignalfile_string = str(orignalfile)
    dt_string_string = str(dt_string)
    username_string = str(username)
    noOfPrint_string = str(noOfPrint)
    outputFileName_string = str(outputFileName)
    
    logme(orignalfile_string, dt_string_string, username_string, noOfPrint_string, outputFileName_string)
